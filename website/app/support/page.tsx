...
const sections=[{id:'quick',label:'Quick help'},{id:'signin',label:'Sign-in help'},{id:'data',label:'Data & sync'},{id:'contact',label:'Contact support'}];
...
<section id="quick"><h2>Quick checks</h2><ol className="steps"><li>Update Mera Markaz from Google Play.</li><li>Restart the app and confirm your internet connection.</li><li>For sign-in, make sure the phone date and time are automatic.</li><li>Do not clear app storage unless you understand that local guest data may be removed.</li></ol></section>
<section id="signin"><h2>Sign-in help</h2><p>For Google, use an account already available on the phone and complete the provider’s prompts. For email, check the address carefully and use the password-reset option when needed. Guest mode does not require an account.</p></section>
